...
const FIRST_INPUT: InputProps = {
  name: 'test',
  label: 'input1',
}
const SECOND_INPUT: InputProps = {
  name: 'test2',
  label: 'input2',
}
const FORM_ITEMS = (
...
const renderForm = (props?: Omit<FormProps, 'formItems' | 'formBottom'>) =>
  render(<Form formItems={FORM_ITEMS} formBottom={FORM_BOTTOM} {...props} />)
